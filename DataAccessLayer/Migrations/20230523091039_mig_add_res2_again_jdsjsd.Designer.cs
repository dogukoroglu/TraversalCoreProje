...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20230523091039_mig_add_res2_again_jdsjsd")]
    partial class mig_add_res2_again_jdsjsd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Reservation2", b =>
                {
                    ...
                    b.Property<DateTime>("ReservationDate2")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Reservation2", b =>
                {
                    b.HasOne("EntityLayer.Concrete.AppUser", "AppUserr")
                        .WithMany("Reservation2s")
                        .HasForeignKey("AppUserrId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
